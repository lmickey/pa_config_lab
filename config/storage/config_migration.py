...
from .pickle_compat import convert_pickle_to_json, detect_config_format, load_config_auto
from .json_storage import save_config_json, get_config_file_path, list_config_files
from ..schema.schema_validator import is_v2_config, is_legacy_config, check_schema_version
...
def upgrade_config_to_latest(
    ...
    if current_version and current_version.startswith("2."):
        ...
        if target_version and current_version != target_version:
            ...
            print(f"Configuration is version {current_version}, target is {target_version}")
        return config
