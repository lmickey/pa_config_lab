...
from .api_endpoints import APIEndpoints, AUTH_URL, build_folder_query, build_pagination_query
from .api_utils import (
    RateLimiter, APICache, handle_api_response, retry_on_failure,
    paginate_api_request, build_headers, extract_folder_from_path
)
...
class PrismaAccessAPIClient:
    ...
    def get_service_connections(self, folder: str = "Service Connections") -> List[Dict[str, Any]]:
    ...
    def get_remote_networks(self, folder: str = "Remote Networks") -> List[Dict[str, Any]]:
        """Get remote networks."""
        # Build query string manually to ensure %20 encoding (not +)
    ...
    def get_all_security_rules(self, folder: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    def get_all_address_groups(self, folder: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    def get_all_service_groups(self, folder: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    def get_all_applications(self, folder: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    def get_all_authentication_profiles(self, folder: Optional[str] = None) -> List[Dict[str, Any]]:
        """Get all authentication profiles with automatic pagination."""
        def api_func(offset=0, limit=100):
            return self.get_authentication_profiles(folder=folder, limit=limit, offset=offset)
